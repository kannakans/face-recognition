...
from tool.face_recognition import FaceDetector
from tool.face_recognition import FaceRecognizer
#from tool.notifications import TwilioNotifier
from tool.utils import Conf
...
ap.add_argument("-n", "--consec-frames", type=int, default=20,
...
while True:
	...
	for (i, (x, y, w, h)) in enumerate(faceRects):
		...
		if prediction == "Unknown" and consec[1] >= args["consec_frames"]:
